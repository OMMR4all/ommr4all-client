import {EditorTools, editorToolToProgressGroup} from '../tool-bar/tool-bar-state.service';
...
export class ActionStatistics {
  ...
  private readonly _actionHistory: {action: ActionType, time: number}[] = [];
  ...
  get sleeping() { return this.pageProgress.getLocked(editorToolToProgressGroup[this._curTool]) || performance.now() - this._lastLifeSign > this.pauseThreshold_ms; }
